    ...
    <BrowserRouter>
      <div className="menu-container">
        ...
        <Sidebar visible={visible} onHide={() => setVisible(false)}>
          <nav className="flex flex-column gap-3 font-barlow text-menu">
            <Link className='font-barlow text-menu' to="/">Inicio</Link>
        ...
        <nav className="hidden md:flex gap-3 mb-3 font-barlow text-menu">
          <Link to="/">Inicio</Link>
          <Link to="/Productos">Productos</Link>
          <Link to="/Nuestra-leyenda">Nuestra leyenda</Link>
          <Link to="/Servicios">Servicios</Link>
