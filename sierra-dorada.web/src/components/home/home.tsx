...
function Home() {
    ...
    return (
        <div>
            ...
            <div className='font-roboto text text-center w-6 mx-auto'>Inspirados en la legendaria búsqueda de El Dorado y la rica cultura Muisca, transformamos los tesoros de nuestra tierra en experiencias cerveceras únicas.</div>
            ...
            <div className="section-with-bg">
                <div className="content">
                    ...
                    <div className='font-roboto text'>Descubre el proceso meticuloso detrás de cada cerveza Sierra Dorada</div>
                    ...
                    <div className='cards-container flex flex-column sm:flex-row gap-4'>
                        {cards.map((card, index) => (
                            <div key={index}>
                                ...
                                <div className='image-title font-barlow-condensed'>{card.title}</div>
                                <div className='font-roboto text'>{card.description}</div>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className='card-text flex flex-column sm:flex-row gap-3'>
                        {cardsTexts.slice(0, 3).map((card, index) => (
                            <div className='card-only p-4' key={index}>
                                ...
                                <h2 className='font-barlow image-title'>{card.title}</h2>
                                <p className='font-roboto text'>{card.text}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className='section-dark mt-8 bt-8 flex flex-column justify-content-center align-items-center'>
                <h1 className='font-barlow title-section'>Descubre el Tesoro de los Andes</h1>
                <div className='font-roboto text text-style-2 text-center w-9'>Únete a nuestra búsqueda por la cerveza perfecta, donde cada sorbo es un tributo a la leyenda de El Dorado y los sabores de nuestra tierra.</div>
            ...
            <div className='section-join mt-8 bt-8 flex flex-column justify-content-center align-items-center'>
                ...
                <div className='font-barlow title-section'>Únete a la Leyenda</div>
                <div className='font-roboto text text-style-2 text-center w-9'>Suscríbete para recibir noticias, eventos exclusivos y ofertas especiales de Sierra Dorada directamente en tu bandeja de entrada.</div>
                <div className='flex flex-column sm:flex-row gap-3 mt-4 col-12 justify-content-center align-items-center'>
                    <InputText className='font-roboto input-text-style col-12 sm:col-6 inputtext-style' placeholder='Tu correo electrónico'></InputText>
                ...
                <div className='font-roboto text small-text w-6 text-center mt-4'>Al suscribirte, aceptas recibir correos electrónicos de marketing de Sierra Dorada. Puedes darte de baja en cualquier momento.</div>
            </div>
