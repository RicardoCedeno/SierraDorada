...
const imagesCarousel: imageCarousel[] = [
    ...
    {id: '4f9bc2df-3ec9-47a2-99d0-20b73ffb8b07', colorName: 'Ámbar dorado', colorHex: '#F4A460', name: 'American Pale Ale', price: 18000, inspiration: 'Inspirada en Bochica, héroe civilizador', description: 'Sabiduría líquida. Potente como las enseñanzas de Bochica. guía eterno de los Muiscas', details: {abv: 10, ibu: 50, temperatureRange: '12-14 °C'}, pairing: [{image: '', name: 'Quesos añejos'}, {image: '', name: 'Postres de caramelo'}, {image: '', name: 'Chocolate negro'}], imageUrl: carouselImage2,},
    {id: '807400c9-d68c-4721-8cc6-8635802fa258', colorName: 'Rojo carmesí', colorHex: '#990012', name: 'Sour Ale con Corozo', price: 18000, inspiration: 'Inspirada en Bochica, héroe civilizador', description: 'Sabiduría líquida. Potente como las enseñanzas de Bochica. guía eterno de los Muiscas', details: {abv: 10, ibu: 50, temperatureRange: '12-14 °C'}, pairing: [{image: '', name: 'Quesos añejos'}, {image: '', name: 'Postres de caramelo'}, {image: '', name: 'Chocolate negro'}], imageUrl: carouselImage3},
    {id: 'c6834b3a-3606-4df8-b62a-e283910099e6', colorName: 'Negro intenso', colorHex: '#000000', name: 'Stout Premium', price: 18000, inspiration: 'Inspirada en Bochica, héroe civilizador', description: 'Sabiduría líquida. Potente como las enseñanzas de Bochica. guía eterno de los Muiscas', details: {abv: 10, ibu: 50, temperatureRange: '12-14 °C'}, pairing: [{image: '', name: 'Quesos añejos'}, {image: '', name: 'Postres de caramelo'}, {image: '', name: 'Chocolate negro'}], imageUrl: carouselImage4},
    {id: 'c17f1ce6-dafe-4904-af44-fe4ffed2beef', colorName: 'Negro intenso', colorHex: '#000000', name: 'Stout Premium', price: 18000, inspiration: 'Inspirada en Bochica, héroe civilizador', description: 'Sabiduría líquida. Potente como las enseñanzas de Bochica. guía eterno de los Muiscas', details: {abv: 10, ibu: 50, temperatureRange: '12-14 °C'}, pairing: [{image: '', name: 'Quesos añejos'}, {image: '', name: 'Postres de caramelo'}, {image: '', name: 'Chocolate negro'}], imageUrl: carouselImage4}
